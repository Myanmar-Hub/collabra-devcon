 ...
 * on 2013-11-20 at 11:29:09 UTC 
 * Modify at your own risk.
 */

package net.myanmarhub.collabra.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
     ...
     * @since 1.7
     */
    public static final String DEFAULT_ROOT_URL = "https://myanhub_collabra.appspot.com/_ah/api/";
    ...
    public class GetDeviceInfo extends DeviceinfoendpointRequest<net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo> {
        ...
        protected GetDeviceInfo(java.lang.String id) {
            super(Deviceinfoendpoint.this, "GET", REST_PATH, null, net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo.class);
     ...
     * operation.
     *
     * @param content the {@link net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo}
     * @return the request
     */
    public InsertDeviceInfo insertDeviceInfo(net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
        InsertDeviceInfo result = new InsertDeviceInfo(content);
        initialize(result);
        return result;
    }

    public class InsertDeviceInfo extends DeviceinfoendpointRequest<net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo> {
         ...
         * @since 1.13
         */
        protected InsertDeviceInfo(net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo content) {
            super(Deviceinfoendpoint.this, "POST", REST_PATH, content, net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo.class);
        }
    ...
    public class ListDeviceInfo extends DeviceinfoendpointRequest<net.myanmarhub.collabra.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
        ...
        protected ListDeviceInfo() {
            super(Deviceinfoendpoint.this, "GET", REST_PATH, null, net.myanmarhub.collabra.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
        }
    ...
    public class RemoveDeviceInfo extends DeviceinfoendpointRequest<net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo> {
        ...
        protected RemoveDeviceInfo(java.lang.String id) {
            super(Deviceinfoendpoint.this, "DELETE", REST_PATH, null, net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo.class);
            this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
        }
     ...
     * @return the request
     */
    public UpdateDeviceInfo updateDeviceInfo(net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
        UpdateDeviceInfo result = new UpdateDeviceInfo(content);
        initialize(result);
        return result;
    }

    public class UpdateDeviceInfo extends DeviceinfoendpointRequest<net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo> {
         ...
         * @since 1.13
         */
        protected UpdateDeviceInfo(net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo content) {
            super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, net.myanmarhub.collabra.deviceinfoendpoint.model.DeviceInfo.class);
        }
